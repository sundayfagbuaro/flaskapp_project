    ...
    stages {
        ...
        stage('Copy docker-compose file to docker host'){
            steps{
                ...
                sh """
                    scp -i /var/lib/jenkins/.ssh/id_rsa docker-compose.yml bobosunne@10.10.1.42:/home/bobosunne/deployment/flaskapp"
                    scp -i /var/lib/jenkins/.ssh/id_rsa db_init.sql bobosunne@10.10.1.42:/home/bobosunne/deployment/flaskapp"
                    """
            }
        }
